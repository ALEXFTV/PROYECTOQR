...
from core.erp.validators import vcedula,validacionCantidad,validacionNacimiento,validacionFechaActual,validarLetras,validarLetrass,validarLetrasss,validacionTelefono

#TABLA CLIENTE
class Client(models.Model):
    dni = models.CharField(max_length=10, unique=True, verbose_name='Cédula',validators=[vcedula])
    names = models.CharField(max_length=150, verbose_name='Nombres',validators=[validarLetras])
    surnames = models.CharField(max_length=150, verbose_name='Apellidos',validators=[validarLetrass])
    date_birthday = models.DateField(default=datetime.now, verbose_name='Fecha de nacimiento' )
    address = models.CharField(max_length=150, verbose_name='Dirección',validators=[validarLetrasss])
    telefono = models.CharField(max_length=10, verbose_name='Telefono',validators=[validacionTelefono])
